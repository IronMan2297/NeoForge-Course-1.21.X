package de.ironman.mccourse.worldgen;
...
public class ModConfiguredFeatures {
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> OVERWORLD_BLACK_OPAL_ORE_KEY = registerKey("overworld_black_opal_ore");
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, NETHER_BLACK_OPAL_ORE_KEY, Feature.ORE, new OreConfiguration(netherrackReplaceables,
                ModBlocks.NETHER_BLACK_OPAL_ORE.get().defaultBlockState(), 9));
        register(context, END_BLACK_OPAL_ORE_KEY, Feature.ORE, new OreConfiguration(endReplaceables,
                ModBlocks.END_BLACK_OPAL_ORE.get().defaultBlockState(), 9));
