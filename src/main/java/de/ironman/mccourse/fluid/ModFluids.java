package de.ironman.mccourse.fluid;
...
public class ModFluids {
    ...
    public static final BaseFlowingFluid.Properties BLACK_OPAL_WATER_PROPERTIES = new BaseFlowingFluid.Properties(
            ...
            .slopeFindDistance(2).levelDecreasePerBlock(1).block(ModFluids.BLACK_OPAL_WATER_BLOCK).bucket(ModFluids.BLACK_OPAL_WATER_BUCKET);
